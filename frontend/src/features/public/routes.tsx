...
const ServicePage = lazy(
  () => import("@/features/public/pages/services/ServicePage"),
);
const CoveragePage = lazy(
  () => import("@/features/public/pages/coverage/CoveragePage"),
);
const AboutPage = lazy(() => import("@/features/public/pages/about/AboutPage"));
const PricingPage = lazy(
  () => import("@/features/public/pages/pricing/PricingPage"),
);
const BlogPage = lazy(() => import("@/features/public/pages/blog/BlogPage"));
const ContactPage = lazy(
  () => import("@/features/public/pages/contact/ContactPage"),
);
